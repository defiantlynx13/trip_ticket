...
if( !isset($_GET['action']) || !isset($_GET['id']) || !current_user_can('administrator')){
    wp_redirect( admin_url() . 'admin.php?page=all-in-passengers' );
}

if( isset($_POST['edit-in-pass']) ){
    ...
    wp_redirect(admin_url() . 'admin.php?page=all-in-passengers&user_id='.$user_id );
...
<div class="wrap">
    <h1 class="wp-heading-inline">ویرایش زیرمسافر</h1>
    <a href="admin.php?page=all-passengers" class="page-title-action">همه زیرمسافران</a>
    <br /><br />
    <form method="post">
        <table class="form-table">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input class="regular-text" name="" type="text"  value="<?php echo $pass->date; ?>" disabled/>
                    </td>
                </tr>
        ...
        <br>
        <input type="submit" value="ویرایش مسافر" name="edit-in-pass" class="button-primary" />
